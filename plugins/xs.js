let handler = async (m, { conn, text, mentionedJid }) => {
    ...
    let jodohReasons = [
        ...
        "Siempre encuentran una manera de resolver los problemas juntos.",
    ...
    let tidakReasons = [
        ...
        "Tienden a pelear a menudo y les resulta difícil llegar a un acuerdo.",
